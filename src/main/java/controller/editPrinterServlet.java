...
@WebServlet(name = "editPrinterServlet", value = "/editPrinterServlet")
public class editPrinterServlet extends HttpServlet {
	...
	String edit_printer = "UPDATE printer SET product = ?, color=?, type=?, price=?, count=? WHERE id = ?";
	String userPath;
...
//    }
	 protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			if("/editPrinterServlet".equals(userPath)){
				request.getRequestDispatcher("view/printerEdit.jsp")
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    	...
	    	try (Connection conn = builder.getConnection()){
	    		...
	    		try (PreparedStatement preparedStatement = conn.prepareStatement(edit_printer)){
		       		String strId = request.getParameter("id");
		    		Long id = null; 
					if(strId != null) {
						id = Long.parseLong(strId);
