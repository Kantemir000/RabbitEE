    ...
    <section>
        <article>
            ...
            <div class="text-article">
                <form method="POST" action="" id="edit_laptop" value="${laptopEdit[0].getModel()}" readonly>
                    <p>
                    ...
                    <p>
                        ...
                        <input type="text" name="speed" id="speed" value="${laptopEdit[0].getSpeed()}" readonly/>
                    </p>
                    <p>
                        <label for="ram">Объем оперативной памяти</label>
                        <input type="text" name="ram" id="ram" value="${laptopEdit[0].getRam()}" readonly/>
                    </p>
                    <p>
                        <label for="hd">Объем памяти жесткого диска</label>
                        <input type="text" name="hd" id="hd" value="${laptopEdit[0].getHd()}" readonly/>
                    </p>
                    <p>
                        <label for="screen">Диагональ экрана</label>
                        <input type="text" name="screen" id="screen" value="${laptopEdit[0].getScreen()}" readonly/>
                    </p>
                    <p>
                        <label for="price">Цена</label>
                        <input type="text" name="price" id="price" value="${laptopEdit[0].getPrice()}" readonly/>
                    </p>
                    <p>
                        <label for="count">Количество на складе</label>
                        <input type="text" name="count" id="count" value="${laptopEdit[0].getCount()}" readonly/>
                    </p>
                    
                </form>
                <p>
                    <button type="submit" form="edit_laptop">Удалить</button>
                </p>
            </div>
        </article>
    </section>
