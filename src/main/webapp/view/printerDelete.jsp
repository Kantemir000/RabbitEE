            ...
            <div class="text-article">
                <form method="POST" action="" id="add_printer" >
                    <p>
                        ...
                        <select id="model" name="model" value="${printerEdit[0].getModel()}">
                    ...
                    <p>
                        ...
                        <input type="text" name="color" id="color" value="${printerEdit[0].getColor()}" readonly/>
                    </p>
                    <p>
                        <label for="type">Тип устройства</label>
                        <input type="text" name="type" id="type" value="${printerEdit[0].getType()}" readonly/>
                    </p>
                    <p>
                        <label for="price">Цена</label>
                        <input type="text" name="price" id="price" value="${printerEdit[0].getPrice()}" readonly/>
                    </p>
                    <p>
                        <label for="count">Количество на складе</label>
                        <input type="text" name="count" id="count" value="${printerEdit[0].getCount()}" readonly/>
                    </p>
                </form>
                <p>
                    <button type="submit" form="add_printer">Удалить</button>
                </p>
            </div>
        </article>
    </section>
