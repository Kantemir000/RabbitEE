            ...
            <div class="text-article">
                <form method="POST" action="" id='edit_product'>
                    ...
                    <p>
                        ...
                        <input type="text" name="maker" id="maker" value="${productEdit[0].getMaker()}"/>
                    </p>
                    <p>
                        <label for="type">Тип товара</label>
                        <input type="text" name="type" id="type" value="${productEdit[0].getType()}"/>
                    </p>
                </form>
                <p>
                    <button type="submit" form='edit_product'>Редактировать</button>
                </p>
            </div>
        </article>
    </section>
