                ...
                <div class="text-article">
                    <form method="POST" action="" id="add_pc">
                        ...
                        <p>
                            ...
                            <input type="text" name="speed" id="speed" value="${pcEdit[0].getSpeed()}"/>
                        </p>
                        <p>
                            <label for="ram">Объем оперативной памяти</label>
                            <input type="text" name="ram" id="ram" value="${pcEdit[0].getRam()}"/>
                        </p>
                        <p>
                            <label for="hd">Объем памяти жесткого диска</label>
                            <input type="text" name="hd" id="hd" value="${pcEdit[0].getHd()}"/>
                        </p>
                        <p>
                            <label for="sd">Тип cd-диска</label>
                            <input type="text" name="sd" id="sd" value="${pcEdit[0].getCd()}"/>
                        </p>
                        <p>
                            <label for="price">Цена</label>
                            <input type="text" name="price" id="price" value="${pcEdit[0].getPrice()}"/>
                        </p>
                        <p>
                            <label for="count">Количество на складе</label>
                            <input type="text" name="count" id="count" value="${pcEdit[0].getCount()}"/>
                        </p>
                    </form>
                    <p>
                        <button type="submit" form="add_pc">Редактировать</button>
                    </p>
                </div>
            </article>
        </section>
