            ...
            <div class="text-article">
                <form method="POST" action="" id="add_printer" >
                    ...
                    <p>
                        ...
                        <input type="text" name="color" id="color" value="${printerEdit[0].getColor()}"/>
                    </p>
                    <p>
                        <label for="type">Тип устройства</label>
                        <input type="text" name="type" id="type" value="${printerEdit[0].getType()}"/>
                    </p>
                    <p>
                        <label for="price">Цена</label>
                        <input type="text" name="price" id="price" value="${printerEdit[0].getPrice()}"/>
                    </p>
                    <p>
                        <label for="count">Количество на складе</label>
                        <input type="text" name="count" id="count" value="${printerEdit[0].getCount()}"/>
                    </p>
                </form>
                <p>
                    <button type="submit" form="add_printer">Редактировать</button>
                </p>
            </div>
        </article>
    </section>
